...
- Provide feedback in the web form, and manual highlights/comments in the **1.DATA INPUT** sheet.
- **Important**:
  - Do not add your ORCID
  - **Delete the GBIF submission page** (5.Data Output – GBIF) before returning the file to prevent accidental submission of invalid data.
